...
require_once('../../../application/libraries/configuration.php');
//------------------------------------------------------------------------------
...
$base_url = SITE_URL;  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
...
$relative_image_creation_name_to_prepend= array('','thumb_'); //name to prepend on filename
