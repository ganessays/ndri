   ...
   /**
			...
			$size=0, $selectAttr='',$compareFields0=true, $isDojo=false)
	{
		...
		return _adodb_getmenu($this, $name, $defstr,$blank1stItem,$multiple,
			$size, $selectAttr,$compareFields0,$isDojo);
	}
	 ...
	 * @param unknown_type $defstr
	 * @param unknown_type $blank1stItem
	 * @param unknown_type $multiple
	 * @param unknown_type $size
	 * @param unknown_type $selectAttr
	 * @return unknown
	 */
	function GetMenuDojo($name,$defstr='',$blank1stItem=true,$multiple=false,$size=0, $selectAttr='')	
	{
		return $this->GetMenu($name,$defstr,$blank1stItem,$multiple,
			$size, $selectAttr,false, true);
	}
